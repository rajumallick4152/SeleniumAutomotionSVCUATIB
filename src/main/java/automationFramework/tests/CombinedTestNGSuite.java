...
public class CombinedTestNGSuite {
	...
	public void setUp() throws Exception {
		...
		WebDriver driver = BrowserFactory.startBrowser();  // Read browser from config.properties 
	...
	public void loginToApplication() {
		...
		boolean loginSuccess = loginPage.performLogin(test); // config values read inside
