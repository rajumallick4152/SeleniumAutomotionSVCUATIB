...
public class PaymentHistoryPage extends BasePage {
    ...
    private static final By PROCEED_BUTTON_REMARKS = By.xpath("(//span[text()='Proceed'])[1]"); // First Proceed button after remarks
    private static final By PROCEED_BUTTON_OTP = By.xpath("(//span[text()='Proceed'])[2]");     // Second Proceed button after OTP
    ...
    private static final By NEFT_OPTION = By.xpath("//*[normalize-space(text())='NEFT']/ancestor::*[self::div or self::label or self::button][1]");
    private static final By NEFT_SELECTED_ICON = By.xpath("//span[normalize-space(text())='NEFT']/following-sibling::img[contains(@src, 'ic_tickCircle_green')]");
